...
# -*- coding: utf-8 -*-
#
# ipymolsysview documentation build configuration file
#
...
project = 'ipymolsysview'
copyright = '2023, Diego Prada'
author = 'Diego Prada'
...
_version_py = os.path.join(repo, 'ipymolsysview', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipymolsysviewdoc'
...
latex_documents = [
    (master_doc, 'ipymolsysview.tex', 'ipymolsysview Documentation',
     'Diego Prada', 'manual'),
]
